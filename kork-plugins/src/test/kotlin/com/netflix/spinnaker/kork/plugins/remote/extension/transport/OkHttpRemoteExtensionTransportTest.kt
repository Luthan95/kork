  ...
  fun tests() = rootContext<Fixture> {
    ...
    test ("Read response type") {
      val response = Response.Builder()
        ...
        .body("{\"type\": \"readResponse\", \"foo\": \"bar\"}".toResponseBody("application/json".toMediaTypeOrNull()))
        .build()
    ...
    test ("Write response type") {
      val response = Response.Builder()
        ...
        .message("OK")
        .header("Content-Type", "application/json")
        .body("{\"type\": \"writeResponse\", \"foo\": \"bar\"}".toResponseBody("application/json".toMediaTypeOrNull()))
        .build()
